...
<template>
    <transition>
        <div v-if="show" ref="wrapElRef" tabindex="-1" :style="{ 'z-index': zIndex }" class="image-viewer__wrapper">
            ...
            <template v-if="!isSingle">
                <span class="image-viewer__btn image-viewer__prev" :class="{ 'is-disabled': !infinite && isFirst }" @click="prev">
                    <i class="el-icon-arrow-left cursor-pointer" />
                </span>
                <span class="image-viewer__btn image-viewer__next" :class="{ 'is-disabled': !infinite && isLast }" @click="next">
                    <i class="el-icon-arrow-right cursor-pointer" />
                </span>
            </template>
            <!-- ACTIONS -->
            <div class="image-viewer__btn image-viewer__actions">
                <div class="image-viewer__actions__inner">
                    <i class="my-ico-unscale ico-style" @click="handleActions('zoomIn')" />
                    <i class="my-ico-scale ico-style" @click="handleActions('zoomOut')" />
                    <i class="my-ico-resume ico-style" @click="toggleMode" />
                    <i class="my-ico-unrotate ico-style" @click="handleActions('anticlocelise')" />
                    <i class="my-ico-rotate ico-style" @click="handleActions('clocelise')" />
                </div>
            </div>
            <!-- CANVAS -->
            <div class="image-viewer__canvas">
                <img ref="imgRef" :src="currentImg" :style="imgStyle" class="image-viewer__img" @load="handleImgLoad" @error="handleImgError" @mousedown="handleMouseDown" @click="select">
            </div>
        </div>
    </transition>
</template>
